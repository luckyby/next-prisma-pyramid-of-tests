        ...
        <div className={styles.description}>
          ...
          <div >
            ...
            <a href="http://localhost:3000/api/hello/Pan" className={styles.card}>
              http://localhost:3000/api/hello/lastname
              (for example lastname = Pan)
            </a><br/>
            <a href="http://localhost:3000/api/helloPan" className={styles.card}>http://localhost:3000/api/helloPan </a><br/>
            <a href="http://localhost:3000/api/weather" className={styles.card} >http://localhost:3000/api/weather </a><br/>
            <a href="http://localhost:3000/api/weather/Lviv" className={styles.card} >
              http://localhost:3000/api/weather/cityname
              (for example cityname = Lviv)
            </a><br/>
          </div>
          <br/>
          ...
          {/*<code className={styles.code}>pages/[cityname].js</code>*/}
